...
import com.example.chatapp.util.CheckSignedIn
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        Column(
            modifier = Modifier
                ...
                .wrapContentHeight()
                .verticalScroll(rememberScrollState()), //assists with scrolling thro limited space
            ...
            Button(
                onClick = {
                    focus.clearFocus(force = true)  //clears after the boxes are filled
                    //call Viewmodel
                    vm.onSignUp(
