...
fun ChatListScreen(navController: NavController, vm: CAViewModel) {
    ...
    if (inProgress)
        ...
        val chats = vm.chats.value   //retrieves chats from Vm model
        ...
        Scaffold(
            ...
            content = {
                ...
                Column(
                    ...
                    if (chats.isEmpty())   //if chat is empty
                        Column(
                        ...
                        //Fill in chats list using lazycolumn
...
fun FAB(
    ...
    if (showDialog)
        AlertDialog(
            onDismissRequest = {
                onDismiss.invoke()
                addChatNumber.value= "" },   //clears the dialogue box once chat is closed
            confirmButton = {
                Button(onClick =
                {
            ...
            text = {
                OutlinedTextField(
                    ...
                    keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Number)  //restrict keyboard to only show numbers
                )
            }
        )
    FloatingActionButton(
